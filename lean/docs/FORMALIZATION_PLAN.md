# Formalization Plan: AI, Human Cognition and Knowledge Collapse
...
1. Proof loop: `lake build +<TouchedPaperModule>`. At closeout, run
   `env LEAN_NUM_THREADS=1 python3 scripts/private_paper_checkpoint.py QX26AgenticDelegation`
   ...
   artifacts.
2. Closeout readiness: `python3 scripts/closeout_reuse_plan.py --paper QX26AgenticDelegation`.
