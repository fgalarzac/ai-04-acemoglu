...
- Paper: *AI, Human Cognition and Knowledge Collapse*
- Authors: Daron Acemoglu, Dingwen Kong, and Asuman Ozdaglar
- Version formalized: NBER Working Paper 34910, February 2026
- Official URL: https://www.nber.org/papers/w34910
- Public PDF: https://www.nber.org/system/files/working_papers/w34910/w34910.pdf
...
- Source-semantic interface: `QX26AgenticDelegation/PaperInterface.lean`
- Proof-endpoint interface: `QX26AgenticDelegation/ProofInterface.lean`
...
5. Begin or resume audit and closeout with
   `python3 scripts/closeout_reuse_plan.py --paper QX26AgenticDelegation` and execute only
   its `next_action`.
...
- [ ] Start with `python3 scripts/closeout_reuse_plan.py --paper QX26AgenticDelegation` and
